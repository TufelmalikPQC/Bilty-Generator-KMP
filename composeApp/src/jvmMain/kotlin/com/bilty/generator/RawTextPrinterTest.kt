 ...
 * Usage: Run this file to print pqc_epson_lx.Txt using the new printRawText() function
 */
fun main() {
    println("═══════════════════════════════════════════════════════")
    ...
    val testFilePath = """C:\Users\Tufel Malik\Downloads\LUNIA COMPANY 2025\LUNIA COMPANY\pqc_epson_lx.Txt"""
    ...
    runBlocking {
        val result: PrintStatus = printerManager.printBiltyText(textContent,null)
        
        val documentsSavedPath = System.getProperty("user.home") + "\\Documents\\bilty_formatted.pdf"
        ...
        when (result) {
            PrintStatus.SUCCESS -> {
                ...
                println("   This shows EXACTLY how pqc_epson_lx.Txt would print!")
            }
            else -> {
                println("❌ FAILED!")
            }
